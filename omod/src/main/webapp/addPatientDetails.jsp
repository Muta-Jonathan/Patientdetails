...
<body>
	<div class="testbox">
		<form action="returnPatientDetails.form">
			...
			<div class="item status">
				...
				<div class="status-item">
					<label><input type="checkbox" name="gender"> <span>Male</span></label>
					<label><input type="checkbox" name="gender"> <span>Female</span></label>
				</div>
			</div>
			<div class="item">
				<p>Patient Issue:</p>
				<input type="text" name="patientissue" />
			</div>
			<div class="item">
				<p>Date of Birth:</p>
				<input type="date" name="birthdate" required /> <i
